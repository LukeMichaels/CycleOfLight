...
#define CONF_NUM_LEDS 1183
#define CONF_NUM_STRIPS 43
//#define CONF_NUM_SENSORS 7
#define CONF_FAVOURITE 8
#define CONF_LED_LAYOUT 28
...
uint8_t getLedStripCount(){
    ...
    stripCount = min(static_cast<int>(stripCount), static_cast<int>(MAX_LED_STRIP_COUNT));
    return stripCount;
}
...
uint16_t getAmountOfLeds(){
    ...
    #endif
    return min(static_cast<int>(MAX_NUM_LEDS), static_cast<int>(configData.numberOfLeds));
}
