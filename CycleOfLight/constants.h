...
#define MAX_NUM_LEDS 255 // only byte values are possible max(255) Memory restriction
...
#define LED_SIZE_X 28
#define LED_SIZE_Y 43
#define INPUTLEFT     // The input to the panel is on the right side
